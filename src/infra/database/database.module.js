...
var notifications_repository_1 = require("@application/repositories/notifications-repository");
    ...
    DatabaseModule = __decorate([
        (0, common_1.Module)({
            providers: [
                ...
                {
                    provide: notifications_repository_1.NotificationRepository,
                    useClass: prisma_notifications_repository_1.PrismaNotificationsRepository
                },
            ],
            exports: [notifications_repository_1.NotificationRepository]
        })
    ], DatabaseModule);
